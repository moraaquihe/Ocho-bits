...
public class AgregarProveedor extends javax.swing.JDialog {
    ...
    public AgregarProveedor(java.awt.Frame parent, boolean modal) {
        ...
        this.txtIdProveedor.setText(funciones.funcionesProveedores.extraerIDMaxPROVEE());
        funciones.funcionesProveedores.cargarComboCiudad();
    ...
    private void initComponents() {
        ...
        botonAgregarNuevoProveedor = new rojerusan.RSButtonHover();
        ...
        botonAgregarNuevoProveedor.setBackground(new java.awt.Color(11, 11, 11));
        botonAgregarNuevoProveedor.setText("Agregar");
        botonAgregarNuevoProveedor.setColorHover(new java.awt.Color(240, 4, 7));
        botonAgregarNuevoProveedor.setName("botonAgregarNuevoProveedor"); // NOI18N
        botonAgregarNuevoProveedor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                botonAgregarNuevoProveedorActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(botonAgregarNuevoProveedor, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(23, 23, 23))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel5)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(botonAgregarNuevoProveedor, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(txtIdProveedor)))
    ...
    private void botonAgregarNuevoProveedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAgregarNuevoProveedorActionPerformed
        try {
            if(this.txtNombreProveedor.getText().length() == 0 || txtCorreo.getText().length()==0 || txtDireccion.getText().length() ==0 || txtRUCCI.getText().length()==0 || txtTelefono.getText().length()==0 || comboCiudad.getSelectedIndex() <=0){
            ...
            if (funciones.funcionesProveedores.isRegister(s)){
                // setClean();
    ...
    }//GEN-LAST:event_botonAgregarNuevoProveedorActionPerformed
    ...
    private rojerusan.RSButtonHover botonAgregarNuevoProveedor;
    ...
    private rojerusan.RSMetroTextFullPlaceHolder txtNombreProveedor;
