 ...
 * @author SailorSakura
 */
public class AgregarClienteVentaSer extends javax.swing.JDialog {

    /**
     * Creates new form AgregarClienteVentaSer
     */
    public AgregarClienteVentaSer(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
         rsutilities.RSUtilities.setCentrarVentana(this);
        funciones.funcionesClientes.cargarComboCiudadVentasSer();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarClienteVentaSer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AgregarClienteVentaSer dialog = new AgregarClienteVentaSer(new javax.swing.JFrame(), true);
