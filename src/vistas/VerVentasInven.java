 ...
 * @author SailorSakura
 */
public class VerVentasInven extends javax.swing.JDialog {

    /**
     * Creates new form VerVentasInven
     */
    public VerVentasInven(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        funciones.funcionesVentas.setListarProductos();
    ...
    private void botonEnviarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonEnviarDatosActionPerformed
        ...
        DefaultTableModel modelo = (DefaultTableModel)vistas.RegistrarVentaInventario.tablaVentaInven.getModel();
        ...
        modelo.addRow(datos);
        vistas.RegistrarVentaInventario.tablaVentaInven.setModel(modelo);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VerVentasInven.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VerVentasInven dialog = new VerVentasInven(new javax.swing.JFrame(), true);
