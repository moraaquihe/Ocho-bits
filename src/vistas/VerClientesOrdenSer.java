 ...
 * @author SailorSakura
 */
public class VerClientesOrdenSer extends javax.swing.JDialog {

    /**
     * Creates new form VerClientesOrdenSer
     */
    public VerClientesOrdenSer(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        funciones.funcionesOrdenServicios.setListarClientes("");
        rsutilities.RSUtilities.setCentrarVentana(this);
        funciones.funcionesClientes.OrdenSerClientes("");
    }
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
        ...
        funciones.funcionesOrdenServicios.setListarClientes(txtBuscar.getText());
    }//GEN-LAST:event_txtBuscarKeyReleased

    private void botonAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAceptarActionPerformed
        int fila = tablaClientes.getSelectedRow();
        if (fila > -1){
            RegistrarOrdenServicios.IdCliente.setText(tablaClientes.getValueAt(fila, 0).toString());
            RegistrarOrdenServicios.lblCliente.setText(tablaClientes.getValueAt(fila, 1).toString());
            dispose();
        } else {
    ...
    private void botonAgregarNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAgregarNuevoActionPerformed
        AgregarClienteOrderSer b = new AgregarClienteOrderSer(new JFrame(), true);
        b.show();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VerClientesOrdenSer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VerClientesOrdenSer dialog = new VerClientesOrdenSer(new javax.swing.JFrame(), true);
