 ...
 * @author SailorSakura
 */
public class AgregarClienteOrderSer extends javax.swing.JDialog {

    /**
     * Creates new form AgregarClienteOrderSer
     */
    public AgregarClienteOrderSer(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
         rsutilities.RSUtilities.setCentrarVentana(this);
        funciones.funcionesClientes.cargarComboCiudadOrdenSer();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarClienteOrderSer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AgregarClienteOrderSer dialog = new AgregarClienteOrderSer(new javax.swing.JFrame(), true);
